  ...
  const ProductDetails = [
    {
      ...
      description:
        "The Apple iPhone 17 Pro delivers flagship performance with a stunning Super Retina XDR OLED display, powered by the ultra-efficient A19 Pro chip and an advanced triple-camera system that captures incredible detail in any lighting condition.",

      halfDec:
        "Built for pro-level photography, smooth high-performance gaming, and seamless multitasking, it offers all-day battery efficiency, a refined premium design, and a fluid user experience that keeps up with everything you do.",
    ...
    <>
      <section className="px-4">
        <Container>
          ...
          <div className="main md:py-15 ">
            <div className="product-img">
              {/* left */}
              <div className="flex flex-col md:flex-row justify-center items-center gap-12">
                <div className="md:w-1/2 flex flex-col md:flex-row gap-6 md:items-start">
                ...
                <div className="md:w-1/2 ">
                  ...
                  <div className="right">
                    ...
                    <div className="">
                      {ProductDetails.map((item) => (
                        <p className="font-sf-pro font-normal text-sm text-gray-dark-400 leading-6">
                          {item.description }
                          {readMore && item.halfDec}
                ...
                {/* buttons */}
                <div className="flex items-center pt-8 gap-4 w-full">
